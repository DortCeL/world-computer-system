					...
					<div className='flex flex-col md:flex-row items-center'>
						...
						<div className='w-full md:w-1/2 mb-6 md:mb-0'>
							<img
								...
								src='/assets/wcs-team.jpg' // Replace with a relevant image
						...
						<div className='w-full md:w-1/2 md:pl-12'>
							...
							<p className='text-lg text-gray-600 mb-4'>
								...
								dedicated to offering high-quality products and excellent
								customer service. Whether you’re a gamer, a creative
								professional, or someone who just loves cutting-edge technology,
